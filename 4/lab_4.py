...
a_0 = 0.983066646300707 
a_1 = -4.1421680652562
a_2 = 7.19330685930494
a_3 = -6.65851590530844
a_4 = 3.51962635242802
a_5 = -1.03611127673578
a_6 = 0.142891261973702
...
#-------------Значение интерполянта в точке-------------#

def interpolant_res(x0):
    return x0**6 * a_6 + x0**5 * a_5 + x0**4 * a_4 + x0**3 * a_3 + x0**2 * a_2 + x0 * a_1 + a_0
...
print('Значение сплайна в x0: ', res(x0, x, c[0], c[1], c[2], c[3]))
print('Значение интерполяционного многочлена в x0: ', interpolant_res(x0))
